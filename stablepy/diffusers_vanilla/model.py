...
class Model_Diffusers:
    ...
    def __call__(
        ...
        if adetailer_active and os.path.exists(self.base_model_id):
            ...
            if adetailer_params["inpaint_only"]["prompt"] is None or adetailer_params["inpaint_only"]["prompt"] == "":
                adetailer_params["inpaint_only"]["prompt"] = None
                adetailer_params["inpaint_only"]["prompt_embeds"] = prompt_emb
            if adetailer_params["inpaint_only"]["negative_prompt"] is None or adetailer_params["inpaint_only"]["negative_prompt"] == "":
            ...
            adetailer.inpaint_pipeline.set_progress_bar_config(disable=disable_progress_bar)
